...
const categories = ["All Resources", "Mental Health", "First Aid", "Safety Helplines", "Legal Rights"];
						...
						<div className="grid gap-4 lg:grid-cols-[1.7fr_1fr] lg:items-center">
							<div>
								...
								<p className="mt-2 text-rose-100">
									Our 24/7 emergency response team and local helplines are available right now. Your safety is
									confidential.
								</p>
								<div className="mt-5 flex flex-wrap gap-2">
